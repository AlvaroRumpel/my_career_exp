      ...
      {career.seasons.length === 0 ? (
        ...
        [...career.seasons]
          ...
          .map(({ season, idx }) => {
            ...
            return (
              <section key={season.year} className="space-y-3 rounded border border-zinc-800 p-4">
